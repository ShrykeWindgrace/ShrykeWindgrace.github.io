...
<details>
<summary>Решение через бином Ньютона</summary>
Заметим, что
$$
9^{999} + 1 = (10-1)^{999} + 1 = \sum_{k=0}^{999} C_{999}^k 10^{999-k}(-1)^k + 1,
$$
где биномиальные коэффициенты имеют вид $C_n^k = \frac{n!}{(n-k)!k!}$.

Рассмотрим несколько последних слагаемых этой суммы:
$$
\sum_{k=0}^{999} C_n^k 10^{999-k}(-1)^k + 1
$$
$$= \sum_{k=0}^{997} C_{999}^k 10^{999-k}(-1)^k + C_{999}^{998} 10^{999-998} (-1)^{998} + C_{999}^{999} 10^{999-999} (-1)^{999} + 1
$$
и, поскольку $C_n^n = 1$ и $C_n^{n-1}=n$,
$$
= \sum_{k=0}^{997} C_{999}^k 10^{999-k}(-1)^k + 9990 - 1  + 1 = \sum_{k=0}^{997} C_{999}^k 10^{999-k}(-1)^k + 9990.
$$

Степени десятки под знаком суммы все не меньше двух; иными словами, $\sum_{k=0}^{997} C_{999}^k 10^{999-k}(-1)^k$ делится на $100$. А $9990$ делится только на $10$, поэтому и вся общая сумма делится только на $10$ (или, что эквивалентно, заканчивается только на один ноль).
</details>